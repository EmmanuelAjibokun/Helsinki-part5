  ...
  return (
    <div>
      ...
      <form onSubmit={handleCreate}>
        ...
        <div>
          <label htmlFor="author">Author:<input id='author' type="text" value={author} onChange={e => setAuthor(e.target.value)} /></label>
        </div>
        <div>
          <label htmlFor="url">Url:<input id='url' type="text" value={url} onChange={e => setUrl(e.target.value)} /></label>
        </div>
